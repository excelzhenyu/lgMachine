 ...
 * @version 2016-06-30
 */
public class LgProductTypeDistributionByProvince extends DataEntity<LgProductTypeDistributionByProvince> {
	...
	public LgProductTypeDistributionByProvince() {
		super();
	}

	public LgProductTypeDistributionByProvince(String id){
		super(id);
	}
