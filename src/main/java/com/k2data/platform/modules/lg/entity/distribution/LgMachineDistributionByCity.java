 ...
 * @version 2016-06-30
 */
public class LgMachineDistributionByCity extends DataEntity<LgMachineDistributionByCity> {
	...
	public LgMachineDistributionByCity() {
		super();
	}

	public LgMachineDistributionByCity(String id){
		super(id);
	}
