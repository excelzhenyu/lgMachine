 ...
 * @version 2016-06-28
 */
public class LgMachineOrderDistributionByCity extends DataEntity<LgMachineOrderDistributionByCity> {
	...
	public LgMachineOrderDistributionByCity() {
		super();
	}

	public LgMachineOrderDistributionByCity(String id){
		super(id);
	}
