 ...
 * @version 2016-07-08
 */
public class LgMachineOrderDistributionByCityBar extends DataEntity<LgMachineOrderDistributionByCityBar> {
	...
	public LgMachineOrderDistributionByCityBar() {
		super();
	}

	public LgMachineOrderDistributionByCityBar(String id){
		super(id);
	}
