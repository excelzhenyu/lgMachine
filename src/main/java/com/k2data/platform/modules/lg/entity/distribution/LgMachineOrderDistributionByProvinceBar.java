 ...
 * @version 2016-07-08
 */
public class LgMachineOrderDistributionByProvinceBar extends DataEntity<LgMachineOrderDistributionByProvinceBar> {
	...
	public LgMachineOrderDistributionByProvinceBar() {
		super();
	}

	public LgMachineOrderDistributionByProvinceBar(String id){
		super(id);
	}
