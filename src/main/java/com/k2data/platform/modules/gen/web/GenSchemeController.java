 ...
 */
package com.k2data.platform.modules.gen.web;
...
import com.k2data.platform.modules.gen.service.GenSchemeService;
import com.k2data.platform.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.k2data.platform.modules");
		}
