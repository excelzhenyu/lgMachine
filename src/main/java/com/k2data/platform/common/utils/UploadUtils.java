...
public class UploadUtils {
	...
	// 图片文件扩展名
	public static final String[] EXTFILE_IMAGE = { ".gif", ".jpg", ".jpeg", ".png", ".bmp" };
	// excel文件扩展名
	public static final String[] EXTFILE_EXCEL = { ".xlsx", ".xls" };
	// 文件保存目录相对路径
	...
	public static String uploadFile(MultipartFile file) throws IllegalStateException, IOException {
		...
		String returnPath = "upload" + separator + getUploadPath() + separator;
		String filePath = PathUtil.getWebInfPath() + returnPath;
		
		String tempName = System.currentTimeMillis() + "."
				+ file.getOriginalFilename().toLowerCase().substring(file.getOriginalFilename().lastIndexOf(".") + 1);
		String fileName = filePath + tempName;
		file.transferTo(new File(fileName));
		return returnPath + tempName;
	...
	public static String getUploadPath() {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMM");// 获取时间格式化工具
