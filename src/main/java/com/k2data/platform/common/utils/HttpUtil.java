...
public class HttpUtil {
	...
	static public String fetch(String method, String url, String body,
		...
		if(conn.getResponseCode() == 200) {
			...
			response = "{\"responseCode\":\"" + conn.getResponseCode() + "\",\"responseMessage\":\"" +  conn.getResponseMessage() + "\"}";
		}
		// handle redirects
	...
	/**
	 * Append query parameters without encode to given url 
	 * @param url         Url as string
	 * @param params      Map with query parameters
	 * @return url        Url with query parameters appended
	 * @throws IOException 
	 */
	static public String appendQueryParamsWithoutEncode(String url, 
			Map<String, String> params) throws IOException {
		String fullUrl = url;
		if (params != null) {
			boolean first = (fullUrl.indexOf('?') == -1);
