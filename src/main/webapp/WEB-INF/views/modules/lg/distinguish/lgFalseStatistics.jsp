		...
		<script type="text/javascript">
			$(document).ready(function () {
				...
				if ($("#contentTable1 tbody tr").length > 0) {
					$.getJSON("${ctx}/lg/lgMissAndFalseStatistics/chartData", {solutionType:1}, function (data) {
						var series1 = [];
						var series2 = [];
						if (data) {
							series1.push({
			...
			$(function () {
				$("[name='modelNumber']").click(function () {
					...
					$.getJSON('${ctx}/lg/lgMissAndFalseStatistics/detailModal', {
						modelNumber:modelNumber,solutionType:1
					}, function (data) {
						if (data) {
				...
				$.getJSON('${ctx}/lg/lgMissAndFalseStatistics/contentTable2', {solutionType:1}, function (data) {
					if (data) {
						...
						$("[name='saleName']").click(function () {
							...
							$.getJSON('${ctx}/lg/lgMissAndFalseStatistics/saleModal', {
								saleName: saleName,solutionType:1
							}, function (data) {
								if (data) {
				...
				<div class="span2 span-rightborder">
					<form:form id="searchForm" modelAttribute="lgFalseStatistics" action="${ctx}/lg/lgMissAndFalseStatistics/query" method="post" class="form-search .form-horizontal">
						...
						<div class="control-group" style="display: none">
							<div class="controls">
								<form:input path="solutionType" value='1' htmlEscape="false" maxlength="64" class="input-xlarge "/>
							</div>
						</div>
				...
				<div id="divRight" class="span10">
					<div class="tabbable" id="tabs-490524">
						<ul class="nav nav-tabs">
							<li class="active">
								<a href="#panel-1" data-toggle="tab">型号虚报统计</a>
							</li>
							<li>
								<a id="tab2" href="#panel-2" data-toggle="tab">经销商虚报统计</a>
							</li>
						</ul>
