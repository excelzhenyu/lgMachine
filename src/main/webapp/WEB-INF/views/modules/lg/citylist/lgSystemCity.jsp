...
<head>
	...
	<script type="text/javascript">
		...
		var moveUrl = "${ctx}/lg/citylist/lgSystemCity/move";
		var delUrl = "${ctx}/lg/citylist/lgSystemCity/delete";
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/lg/citylist/lgSystemCity/tree">业务系统城市</a></li>
	</ul><br/>
	...
	<div class="container-fluid" >
		<div class="row-fluid" >
			...
			<span class="span7"> 
				<h3 id="doWhat"></h3>
				<form:form id="inputForm" modelAttribute="lgSystemCity" action="${ctx}/lg/citylist/lgSystemCity/save" method="post" class="form-horizontal" style="display: none;">
					<form:hidden path="id"/>
