...
<head>
	...
	<script type="text/javascript">
		...
		var lineDate = '${workDate}';//'2016-01-02';

		$.getJSON("${ctx}/lg/distribution/lgMachineJobReport/getMachineJobReportLine", { deviceNo: deviceNo, lineDate: lineDate}, function(data) {
			var series = [];
