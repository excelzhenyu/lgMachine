...
<head>
	...
	<style type="text/css">
		#main {padding:0;margin:0;min-width: 1200px;} #main .container-fluid{padding:0 4px 0 6px;}
		#header {margin:0 0 8px;position:static;} #header li {_font-size:12px;}
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:26px;padding-left:33px;}
		#footer {min-width: 1200px;overflow-x: scrolling;margin: 8px 0 0 0;padding: 3px 0 0 0;font-size: 11px;text-align: center;border-top: 2px solid #0663A2;}
	...
	<script type="text/javascript">
		...
		// <c:if test="${tabmode eq '1'}"> 添加一个页签
		function addChildTab($this,viewvalue, refresh){
			$(".jericho_tab").show();
			$("#mainFrame").hide();
			$.fn.jerichoTab.addTab({
                tabFirer: $this,
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/sys/user/refreshCache"  target="mainFrame"><i class="icon-lock"></i>&nbsp;  刷新缓存</a></li>
						</ul>
					</li>
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;width: auto;">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2016-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.k2data.com.cn/" target="_blank">K2Data</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
