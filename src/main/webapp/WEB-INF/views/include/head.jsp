...
<link href="${ctxStatic}/common/k2data.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/jeesite.js" type="text/javascript"></script>
<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';</script>
<script src="${ctxStatic}/echarts/echarts.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/d3/d3.min.js" type="text/javascript"></script>
...
<script src="${ctxStatic}/lgJs/lgUtils.js" type="text/javascript"></script>
